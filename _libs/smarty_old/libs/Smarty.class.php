...
class Smarty extends Smarty_Internal_TemplateBase {
	...
	public function __construct() {
		...
		$this->debug_tpl = 'file:' . dirname ( __FILE__ ) . '/_debug.tpl';
